...
#define FW_BTN_Pin GPIO_PIN_7
#define FW_BTN_GPIO_Port GPIOG
#define PR_BTN_Pin GPIO_PIN_8
#define PR_BTN_GPIO_Port GPIOG
#define DN_BTN_Pin GPIO_PIN_8
#define DN_BTN_GPIO_Port GPIOC
#define UP_BTN_Pin GPIO_PIN_9
#define UP_BTN_GPIO_Port GPIOC
#define OK_BTN_Pin GPIO_PIN_8
#define OK_BTN_GPIO_Port GPIOA
