...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, DISP_STBY_Pin|DISP_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DISP_STBY_Pin DISP_RST_Pin */
  GPIO_InitStruct.Pin = DISP_STBY_Pin|DISP_RST_Pin;
